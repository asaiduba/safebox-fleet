...
export default function LandingPage({ onGetStarted, user, onBackToDashboard }) {
    // Redirect to Render app with instant transition
    const redirectToApp = () => {
        // Use location.replace for instant redirect (no back button)
        window.location.replace('https://safebox.onrender.com');
    };
        ...
        <div className="landing-page">
            ...
            <header className="landing-header">
                ...
                <nav className="landing-nav">
                    ...
                    {user ? (
                        <button className="login-btn" onClick={handleBackToDashboard}>
            ...
            <section className="hero-section">
                <div className="hero-content">
                    ...
                    <div className="hero-cta">
                        {user ? (
                            <button className="cta-btn primary" onClick={handleBackToDashboard}>Back to Dashboard</button>
                        ) : (
                            <button className="cta-btn primary" onClick={handleGetStarted}>Get Started Now</button>
                        )}
                        <button className="cta-btn secondary" onClick={redirectToApp}>View Demo</button>
                    </div>
                </div>
            ...
            <section id="pricing" className="pricing-section">
                ...
                <div className="pricing-grid">
                    <div className="pricing-card">
                        ...
                        <button className="pricing-btn" onClick={handleGetStarted}>Choose Starter</button>
                    </div>
                    <div className="pricing-card popular">
                        ...
                        <button className="pricing-btn primary" onClick={handleGetStarted}>Choose Business</button>
                    </div>
                    <div className="pricing-card">
                        <h3>Enterprise</h3>
